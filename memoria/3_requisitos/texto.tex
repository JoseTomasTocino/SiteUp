...
\begin{center}
  ...
  \begin{tabularx}{\textwidth}{|c|X|}
    ...
    \hline
  \end{tabularx}
  \captionof{table}{RQF-3, req. funcional 3: creación de grupo de chequeos}
\end{center}
...
\begin{center}
  ...
  \begin{tabularx}{\textwidth}{|c|X|}
    ...
    \hline
  \end{tabularx}
  \captionof{table}{RQF-4, req. funcional 4: edición de grupo de chequeos}
\end{center}
...
\begin{center}
  ...
  \begin{tabularx}{\textwidth}{|c|X|}
    ...
    \hline
  \end{tabularx}
  \captionof{table}{RQF-5, req. funcional 5: eliminación de grupo de chequeos}
\end{center}
...
\begin{center}
  ...
  \begin{tabularx}{\textwidth}{|c|X|}
    ...
    \hline
  \end{tabularx}
  \captionof{table}{RQF-6, req. funcional 6: activación de grupo de chequeos}
\end{center}
...
\begin{center}
  ...
  \begin{tabularx}{\textwidth}{|c|X|}
    ...
    \hline
  \end{tabularx}
  \captionof{table}{RQF-7, req. funcional 7: creación de chequeos}
\end{center}
...
\begin{center}
  ...
  \begin{tabularx}{\textwidth}{|c|X|}
    ...
    \hline
  \end{tabularx}
  \captionof{table}{RQF-8, req. funcional 8: actualización de chequeos}
\end{center}
...
\begin{center}
  ...
  \begin{tabularx}{\textwidth}{|c|X|}
    ...
    \hline
  \end{tabularx}
  \captionof{table}{RQF-9, req. funcional 9: eliminación de chequeos}
\end{center}
...
\begin{center}
  ...
  \begin{tabularx}{\textwidth}{|c|X|}
    ...
    \hline
  \end{tabularx}
  \captionof{table}{RQF-11, req. funcional 11: activación de chequeos}
\end{center}
...
\begin{center}
  ...
  \begin{tabularx}{\textwidth}{|c|X|}
    ...
    \hline
  \end{tabularx}
  \captionof{table}{RQF-11, req. funcional 11: revisión de chequeos}
\end{center}
...
\begin{center}
  ...
  \begin{tabularx}{\textwidth}{|c|X|}
    ...
    \hline
  \end{tabularx}
  \captionof{table}{RQF-12, req. funcional 12: notificación por correo}
\end{center}
...
\begin{center}
  ...
  \begin{tabularx}{\textwidth}{|c|X|}
    ...
    \hline
  \end{tabularx}
  \captionof{table}{RQF-13, req. funcional 13: lanzamiento de chequeos}
\end{center}
...
\begin{center}
  ...
  \begin{tabularx}{\textwidth}{|c|X|}
    ...
    \hline
  \end{tabularx}
  \captionof{table}{RQF-14, req. funcional 14: mantenimiento de registros}
\end{center}
...
\begin{center}
  ...
  \begin{tabularx}{\textwidth}{|c|X|}
    ...
    \hline
  \end{tabularx}
  \captionof{table}{RQF-15, req. funcional 15: listado de chequeos en app}
\end{center}
...
\begin{center}
  ...
  \begin{tabularx}{\textwidth}{|c|X|}
    ...
    \hline
  \end{tabularx}
  \captionof{table}{RQF-16, req. funcional 16: notificaciones mediante la app}
\end{center}
...
\begin{center}
  ...
  \end{tabularx}
  \captionof{table}{IRQ-2, req. de información 2: chequeo Ping}
\end{center}
...
\begin{center}
  ...
  \end{tabularx}
  \captionof{table}{IRQ-3, req. de información 3: chequeo DNS}
\end{center}
...
\begin{center}
  ...
  \end{tabularx}
  \captionof{table}{IRQ-4, req. de información 4: chequeo de puerto}
\end{center}
...
\begin{center}
  ...
  \end{tabularx}
  \captionof{table}{IRQ-5, req. de información 5: chequeo HTTP}
\end{center}
...
\begin{center}
  ...
  \end{tabularx}
  \captionof{table}{IRQ-6, req. de información 6: registro de chequeo}
\end{center}
...
\begin{center}
  ...
  \end{tabularx}
  \captionof{table}{IRQ-7, req. de información 7: estado de chequeo}
\end{center}
...
\begin{center}
  ...
  \end{tabularx}
  \captionof{table}{IRQ-8, req. de información 8: grupo de chequeos}
\end{center}
...
\begin{center}
  ...
  \begin{tabularx}{\textwidth}{|c|X|}
    ...
    \hline
  \end{tabularx}
  \captionof{table}{NRQ-1, req. no funcional 1: cifrado de contraseñas}
\end{center}
...
\begin{center}
  ...
  \begin{tabularx}{\textwidth}{|c|X|}
    ...
    \hline
  \end{tabularx}
  \captionof{table}{NRQ-2, req. no funcional 2: control de acceso}
\end{center}
...
\begin{center}
  ...
  \begin{tabularx}{\textwidth}{|c|X|}
    ...
    \hline
  \end{tabularx}
  \captionof{table}{NRQ-3, req. no funcional 3: ejecución de chequeos}
\end{center}
...
\begin{center}
  ...
  \captionof{table}{NRQ-4, req. no funcional 4: adaptación a dispositivos}
\end{center}
...
\begin{center}
  ...
  \begin{tabularx}{\textwidth}{|c|X|}
    ...
    \hline
  \end{tabularx}
  \captionof{table}{NRQ-5, req. no funcional 5: monitorización de la ejecución}
\end{center}
