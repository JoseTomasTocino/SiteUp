...
\subsection{Lanzamiento y notificación de un chequeo}
...
El resultado es devuelto al método \texttt{run\_check}, y éste se encarga de
...
\textit{\nameref{subsec:instalacion-credenciales}} del manual de instalación).
