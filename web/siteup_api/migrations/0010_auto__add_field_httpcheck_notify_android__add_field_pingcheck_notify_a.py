...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HttpCheck.notify_android'
        db.add_column(u'siteup_api_httpcheck', 'notify_android',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'PingCheck.notify_android'
        db.add_column(u'siteup_api_pingcheck', 'notify_android',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'DnsCheck.notify_android'
        db.add_column(u'siteup_api_dnscheck', 'notify_android',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'PortCheck.notify_android'
        db.add_column(u'siteup_api_portcheck', 'notify_android',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HttpCheck.notify_android'
        db.delete_column(u'siteup_api_httpcheck', 'notify_android')

        # Deleting field 'PingCheck.notify_android'
        db.delete_column(u'siteup_api_pingcheck', 'notify_android')

        # Deleting field 'DnsCheck.notify_android'
        db.delete_column(u'siteup_api_dnscheck', 'notify_android')

        # Deleting field 'PortCheck.notify_android'
        db.delete_column(u'siteup_api_portcheck', 'notify_android')
