...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CheckStatus'
        db.create_table(u'siteup_api_checkstatus', (
        ...
        db.send_create_signal(u'siteup_api', ['CheckStatus'])

        # Adding field 'HttpCheck.last_status'
        db.add_column(u'siteup_api_httpcheck', 'last_status',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['siteup_api.CheckStatus'], null=True),
                      keep_default=False)

        # Deleting field 'CheckLog.notified'
        db.delete_column(u'siteup_api_checklog', 'notified')

        # Adding field 'DnsCheck.last_status'
        db.add_column(u'siteup_api_dnscheck', 'last_status',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['siteup_api.CheckStatus'], null=True),
                      keep_default=False)

        # Adding field 'PingCheck.last_status'
        db.add_column(u'siteup_api_pingcheck', 'last_status',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['siteup_api.CheckStatus'], null=True),
                      keep_default=False)

        # Adding field 'PortCheck.last_status'
        db.add_column(u'siteup_api_portcheck', 'last_status',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['siteup_api.CheckStatus'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'CheckStatus'
        db.delete_table(u'siteup_api_checkstatus')

        # Deleting field 'HttpCheck.last_status'
        db.delete_column(u'siteup_api_httpcheck', 'last_status_id')

        # Adding field 'CheckLog.notified'
        db.add_column(u'siteup_api_checklog', 'notified',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'DnsCheck.last_status'
        db.delete_column(u'siteup_api_dnscheck', 'last_status_id')

        # Deleting field 'PingCheck.last_status'
        db.delete_column(u'siteup_api_pingcheck', 'last_status_id')

        # Deleting field 'PortCheck.last_status'
        db.delete_column(u'siteup_api_portcheck', 'last_status_id')
    ...
    models = {
        ...
        u'siteup_api.dnscheck': {
            ...
            'last_status': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['siteup_api.CheckStatus']", 'null': 'True'}),
