...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CheckLog.response_time'
        db.alter_column(u'siteup_api_checklog', 'response_time', self.gf('django.db.models.fields.FloatField')())

    def backwards(self, orm):

        # Changing field 'CheckLog.response_time'
        db.alter_column(u'siteup_api_checklog', 'response_time', self.gf('django.db.models.fields.IntegerField')())
