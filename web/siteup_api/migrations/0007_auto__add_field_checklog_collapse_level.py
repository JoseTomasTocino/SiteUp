...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CheckLog.collapse_level'
        db.add_column(u'siteup_api_checklog', 'collapse_level',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CheckLog.collapse_level'
        db.delete_column(u'siteup_api_checklog', 'collapse_level')
