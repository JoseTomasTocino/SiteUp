...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserExtra'
        db.create_table(u'siteup_api_userextra', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('send_report', self.gf('django.db.models.fields.BooleanField')()),
        ))
        db.send_create_signal(u'siteup_api', ['UserExtra'])


    def backwards(self, orm):
        # Deleting model 'UserExtra'
        db.delete_table(u'siteup_api_userextra')
