...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HttpCheck.consecutive_logs_for_failure'
        db.add_column(u'siteup_api_httpcheck', 'consecutive_logs_for_failure',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=2),
                      keep_default=False)

        # Adding field 'PingCheck.consecutive_logs_for_failure'
        db.add_column(u'siteup_api_pingcheck', 'consecutive_logs_for_failure',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=2),
                      keep_default=False)

        # Adding field 'DnsCheck.consecutive_logs_for_failure'
        db.add_column(u'siteup_api_dnscheck', 'consecutive_logs_for_failure',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=2),
                      keep_default=False)

        # Adding field 'PortCheck.consecutive_logs_for_failure'
        db.add_column(u'siteup_api_portcheck', 'consecutive_logs_for_failure',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HttpCheck.consecutive_logs_for_failure'
        db.delete_column(u'siteup_api_httpcheck', 'consecutive_logs_for_failure')

        # Deleting field 'PingCheck.consecutive_logs_for_failure'
        db.delete_column(u'siteup_api_pingcheck', 'consecutive_logs_for_failure')

        # Deleting field 'DnsCheck.consecutive_logs_for_failure'
        db.delete_column(u'siteup_api_dnscheck', 'consecutive_logs_for_failure')

        # Deleting field 'PortCheck.consecutive_logs_for_failure'
        db.delete_column(u'siteup_api_portcheck', 'consecutive_logs_for_failure')
    ...
    models = {
        ...
        u'siteup_api.checklog': {
            ...
            'collapse_level': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contenttypes.ContentType']"}),
            'date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'object_id': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'response_time': ('django.db.models.fields.FloatField', [], {'default': '0'}),
        ...
        u'siteup_api.dnscheck': {
            ...
            'consecutive_logs_for_failure': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '2'}),
            ...
            'notify_android': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        u'siteup_api.userextra': {
            'Meta': {'object_name': 'UserExtra'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'regid': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'send_report': ('django.db.models.fields.BooleanField', [], {}),
