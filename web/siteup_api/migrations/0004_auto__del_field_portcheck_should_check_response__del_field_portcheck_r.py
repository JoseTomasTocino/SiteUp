...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PortCheck.should_check_response'
        db.delete_column(u'siteup_api_portcheck', 'should_check_response')

        # Deleting field 'PortCheck.response_value'
        db.delete_column(u'siteup_api_portcheck', 'response_value')

        # Adding field 'PortCheck.response_check_string'
        db.add_column(u'siteup_api_portcheck', 'response_check_string',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PortCheck.should_check_response'
        db.add_column(u'siteup_api_portcheck', 'should_check_response',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PortCheck.response_value'
        db.add_column(u'siteup_api_portcheck', 'response_value',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Deleting field 'PortCheck.response_check_string'
        db.delete_column(u'siteup_api_portcheck', 'response_check_string')
