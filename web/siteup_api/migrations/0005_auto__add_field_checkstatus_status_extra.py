...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CheckStatus.status_extra'
        db.add_column(u'siteup_api_checkstatus', 'status_extra',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CheckStatus.status_extra'
        db.delete_column(u'siteup_api_checkstatus', 'status_extra')
